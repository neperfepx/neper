...
void
ANNkd_split::print (		// print splitting node
...
void
ANNkd_leaf::print (		// print leaf node
		    int level,	// depth of node in tree
		    ostream & out)	// output stream
{
...
void
ANNkd_tree::Print (		// print entire tree
...
void
ANNkd_leaf::getStats (		// get subtree statistics
...
void
ANNkd_split::getStats (		// get subtree statistics
			int dim,	// dimension of space
			ANNkdStats & st,	// stats (modified)
			ANNorthRect & bnd_box)	// bounding box
{
...
void
ANNkd_tree::getStats (		// get tree statistics
		       ANNkdStats & st)	// stats (modified)
{
...
void
ANNkd_tree::SkeletonTree (	// construct skeleton tree
...
ANNkd_ptr
rkd_tree (			// recursive construction of kd-tree
	   ANNpointArray pa,	// point array
