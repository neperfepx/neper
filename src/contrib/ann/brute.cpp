...
void
ANNbruteForce::annkSearch (	// approx k near neighbor search
			    ...
			    double eps)	// error bound (ignored)
{
  ...
  if (eps > DBL_MAX)
   abort (); // trick to disable warning
...
int
ANNbruteForce::annkFRSearch (	// approx fixed-radius kNN search
			      ANNpoint q,	// query point
