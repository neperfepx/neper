...
extern void   ut_vector_set_covar (double **vects, int vectqty, int dim, double **covar);
...
extern void   ut_vector_set_eigen (double **vects, int vectqty, int dim, double **evect, double *eval);
