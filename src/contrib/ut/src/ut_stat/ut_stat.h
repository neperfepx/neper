...
/// \param *pres: test
/// \return 0
  extern int ut_stat_test_ks (double *dis1, double *dis2, int qty,
                              double *pres);
...
/// \param *pres: test
/// \return 0
  extern int ut_stat_test_kuiper (double *dis1, double *dis2, int qty,
                                  double *pres);
...
/// \param distrib: distribution (must be preallocated)
  extern void ut_stat_distrib (double *array, int size, double step,
