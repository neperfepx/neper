...
extern void ut_print_messagewnc (int head, int nbcolmax, const char *message);
...
extern void ut_print_wnc (FILE * file, int *pnbcol, int nbcolmax, const char* string, ...);
...
/// \param *pnbcol: current column position
/// \param nbcolmax: maximal number of columns
extern void ut_print_wnc_int (FILE * file, int nb, int *pnbcol, int nbcolmax);
...
/// \param *pnbcol: current column position
/// \param nbcolmax: maximal number of columns
extern int  ut_print_wnc_string (FILE * file, const char *string, int *pnbcol, int nbcolmax);
...
/// \param string: character string (can be multiple arguments)
extern void ut_print_wnc_wnelts (FILE * file, int *pnbcol, int nbcolmax, int* pnbelts,
                                 int nbeltmax, const char* string, ...);
...
extern void ut_print_moduleheader (const char *module, int fargv, char **fargc,
                                   int argv, char **argc);
