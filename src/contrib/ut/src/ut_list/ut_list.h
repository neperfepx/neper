...
extern void ut_list_break (const char *list, const char* sep, char ***pparts, int *psize);
...
extern void ut_list_break2 (const char *list, const char *sep1, const char *sep2, char ****pparts, int **psize2, int *psize1);
...
extern int ut_list_testelt (const char *list, const char *sep, const char *elt);
