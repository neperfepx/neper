...
ut_color_name_rgb (char *name, int *c)
{
  ...
  // manimcolors
  else if (!strcmp (name, "manimblack"))
    ut_array_1d_int_set_3 (c, 0, 0, 0);
  else if (!strcmp (name, "manimblue"))
    ut_array_1d_int_set_3 (c, 88, 196, 221);
  else if (!strcmp (name, "manimblue_a"))
    ut_array_1d_int_set_3 (c, 199, 233, 241);
  else if (!strcmp (name, "manimblue_b"))
    ut_array_1d_int_set_3 (c, 156, 220, 235);
  else if (!strcmp (name, "manimblue_c"))
    ut_array_1d_int_set_3 (c, 88, 196, 221);
  else if (!strcmp (name, "manimblue_d"))
    ut_array_1d_int_set_3 (c, 41, 171, 202);
  else if (!strcmp (name, "manimblue_e"))
    ut_array_1d_int_set_3 (c, 35, 107, 142);
  else if (!strcmp (name, "manimdarker_gray"))
    ut_array_1d_int_set_3 (c, 34, 34, 34);
  else if (!strcmp (name, "manimdarker_grey"))
    ut_array_1d_int_set_3 (c, 34, 34, 34);
  else if (!strcmp (name, "manimdark_blue"))
    ut_array_1d_int_set_3 (c, 35, 107, 142);
  else if (!strcmp (name, "manimdark_brown"))
    ut_array_1d_int_set_3 (c, 139, 69, 19);
  else if (!strcmp (name, "manimdark_gray"))
    ut_array_1d_int_set_3 (c, 68, 68, 68);
  else if (!strcmp (name, "manimdark_grey"))
    ut_array_1d_int_set_3 (c, 68, 68, 68);
  else if (!strcmp (name, "manimgold"))
    ut_array_1d_int_set_3 (c, 240, 172, 95);
  else if (!strcmp (name, "manimgold_a"))
    ut_array_1d_int_set_3 (c, 247, 199, 151);
  else if (!strcmp (name, "manimgold_b"))
    ut_array_1d_int_set_3 (c, 249, 183, 117);
  else if (!strcmp (name, "manimgold_c"))
    ut_array_1d_int_set_3 (c, 240, 172, 95);
  else if (!strcmp (name, "manimgold_d"))
    ut_array_1d_int_set_3 (c, 225, 161, 88);
  else if (!strcmp (name, "manimgold_e"))
    ut_array_1d_int_set_3 (c, 199, 141, 70);
  else if (!strcmp (name, "manimgray"))
    ut_array_1d_int_set_3 (c, 136, 136, 136);
  else if (!strcmp (name, "manimgray_a"))
    ut_array_1d_int_set_3 (c, 221, 221, 221);
  else if (!strcmp (name, "manimgray_b"))
    ut_array_1d_int_set_3 (c, 187, 187, 187);
  else if (!strcmp (name, "manimgray_brown"))
    ut_array_1d_int_set_3 (c, 115, 99, 87);
  else if (!strcmp (name, "manimgray_c"))
    ut_array_1d_int_set_3 (c, 136, 136, 136);
  else if (!strcmp (name, "manimgray_d"))
    ut_array_1d_int_set_3 (c, 68, 68, 68);
  else if (!strcmp (name, "manimgray_e"))
    ut_array_1d_int_set_3 (c, 34, 34, 34);
  else if (!strcmp (name, "manimgreen"))
    ut_array_1d_int_set_3 (c, 131, 193, 103);
  else if (!strcmp (name, "manimgreen_a"))
    ut_array_1d_int_set_3 (c, 201, 226, 174);
  else if (!strcmp (name, "manimgreen_b"))
    ut_array_1d_int_set_3 (c, 166, 207, 140);
  else if (!strcmp (name, "manimgreen_c"))
    ut_array_1d_int_set_3 (c, 131, 193, 103);
  else if (!strcmp (name, "manimgreen_d"))
    ut_array_1d_int_set_3 (c, 119, 176, 93);
  else if (!strcmp (name, "manimgreen_e"))
    ut_array_1d_int_set_3 (c, 105, 156, 82);
  else if (!strcmp (name, "manimgrey"))
    ut_array_1d_int_set_3 (c, 136, 136, 136);
  else if (!strcmp (name, "manimgrey_a"))
    ut_array_1d_int_set_3 (c, 221, 221, 221);
  else if (!strcmp (name, "manimgrey_b"))
    ut_array_1d_int_set_3 (c, 187, 187, 187);
  else if (!strcmp (name, "manimgrey_brown"))
    ut_array_1d_int_set_3 (c, 115, 99, 87);
  else if (!strcmp (name, "manimgrey_c"))
    ut_array_1d_int_set_3 (c, 136, 136, 136);
  else if (!strcmp (name, "manimgrey_d"))
    ut_array_1d_int_set_3 (c, 68, 68, 68);
  else if (!strcmp (name, "manimgrey_e"))
    ut_array_1d_int_set_3 (c, 34, 34, 34);
  else if (!strcmp (name, "manimlighter_gray"))
    ut_array_1d_int_set_3 (c, 221, 221, 221);
  else if (!strcmp (name, "manimlighter_grey"))
    ut_array_1d_int_set_3 (c, 221, 221, 221);
  else if (!strcmp (name, "manimlight_brown"))
    ut_array_1d_int_set_3 (c, 205, 133, 63);
  else if (!strcmp (name, "manimlight_gray"))
    ut_array_1d_int_set_3 (c, 187, 187, 187);
  else if (!strcmp (name, "manimlight_grey"))
    ut_array_1d_int_set_3 (c, 187, 187, 187);
  else if (!strcmp (name, "manimlight_pink"))
    ut_array_1d_int_set_3 (c, 220, 117, 205);
  else if (!strcmp (name, "manimlogo_black"))
    ut_array_1d_int_set_3 (c, 52, 52, 52);
  else if (!strcmp (name, "manimlogo_blue"))
    ut_array_1d_int_set_3 (c, 82, 88, 147);
  else if (!strcmp (name, "manimlogo_green"))
    ut_array_1d_int_set_3 (c, 135, 194, 165);
  else if (!strcmp (name, "manimlogo_red"))
    ut_array_1d_int_set_3 (c, 224, 122, 95);
  else if (!strcmp (name, "manimlogo_white"))
    ut_array_1d_int_set_3 (c, 236, 231, 226);
  else if (!strcmp (name, "manimmaroon"))
    ut_array_1d_int_set_3 (c, 197, 95, 115);
  else if (!strcmp (name, "manimmaroon_a"))
    ut_array_1d_int_set_3 (c, 236, 171, 193);
  else if (!strcmp (name, "manimmaroon_b"))
    ut_array_1d_int_set_3 (c, 236, 146, 171);
  else if (!strcmp (name, "manimmaroon_c"))
    ut_array_1d_int_set_3 (c, 197, 95, 115);
  else if (!strcmp (name, "manimmaroon_d"))
    ut_array_1d_int_set_3 (c, 162, 77, 97);
  else if (!strcmp (name, "manimmaroon_e"))
    ut_array_1d_int_set_3 (c, 148, 66, 79);
  else if (!strcmp (name, "manimorange"))
    ut_array_1d_int_set_3 (c, 255, 134, 47);
  else if (!strcmp (name, "manimpink"))
    ut_array_1d_int_set_3 (c, 209, 71, 189);
  else if (!strcmp (name, "manimpure_blue"))
    ut_array_1d_int_set_3 (c, 0, 0, 255);
  else if (!strcmp (name, "manimpure_green"))
    ut_array_1d_int_set_3 (c, 0, 255, 0);
  else if (!strcmp (name, "manimpure_red"))
    ut_array_1d_int_set_3 (c, 255, 0, 0);
  else if (!strcmp (name, "manimpurple"))
    ut_array_1d_int_set_3 (c, 154, 114, 172);
  else if (!strcmp (name, "manimpurple_a"))
    ut_array_1d_int_set_3 (c, 202, 163, 232);
  else if (!strcmp (name, "manimpurple_b"))
    ut_array_1d_int_set_3 (c, 177, 137, 198);
  else if (!strcmp (name, "manimpurple_c"))
    ut_array_1d_int_set_3 (c, 154, 114, 172);
  else if (!strcmp (name, "manimpurple_d"))
    ut_array_1d_int_set_3 (c, 113, 85, 130);
  else if (!strcmp (name, "manimpurple_e"))
    ut_array_1d_int_set_3 (c, 100, 65, 114);
  else if (!strcmp (name, "manimred"))
    ut_array_1d_int_set_3 (c, 252, 98, 85);
  else if (!strcmp (name, "manimred_a"))
    ut_array_1d_int_set_3 (c, 247, 161, 163);
  else if (!strcmp (name, "manimred_b"))
    ut_array_1d_int_set_3 (c, 255, 128, 128);
  else if (!strcmp (name, "manimred_c"))
    ut_array_1d_int_set_3 (c, 252, 98, 85);
  else if (!strcmp (name, "manimred_d"))
    ut_array_1d_int_set_3 (c, 230, 90, 76);
  else if (!strcmp (name, "manimred_e"))
    ut_array_1d_int_set_3 (c, 207, 80, 68);
  else if (!strcmp (name, "manimteal"))
    ut_array_1d_int_set_3 (c, 92, 208, 179);
  else if (!strcmp (name, "manimteal_a"))
    ut_array_1d_int_set_3 (c, 172, 234, 215);
  else if (!strcmp (name, "manimteal_b"))
    ut_array_1d_int_set_3 (c, 118, 221, 192);
  else if (!strcmp (name, "manimteal_c"))
    ut_array_1d_int_set_3 (c, 92, 208, 179);
  else if (!strcmp (name, "manimteal_d"))
    ut_array_1d_int_set_3 (c, 85, 193, 167);
  else if (!strcmp (name, "manimteal_e"))
    ut_array_1d_int_set_3 (c, 73, 168, 143);
  else if (!strcmp (name, "manimwhite"))
    ut_array_1d_int_set_3 (c, 255, 255, 255);
  else if (!strcmp (name, "manimyellow"))
    ut_array_1d_int_set_3 (c, 255, 255, 0);
  else if (!strcmp (name, "manimyellow_a"))
    ut_array_1d_int_set_3 (c, 255, 241, 182);
  else if (!strcmp (name, "manimyellow_b"))
    ut_array_1d_int_set_3 (c, 255, 234, 148);
  else if (!strcmp (name, "manimyellow_c"))
    ut_array_1d_int_set_3 (c, 255, 255, 0);
  else if (!strcmp (name, "manimyellow_d"))
    ut_array_1d_int_set_3 (c, 244, 211, 69);
  else if (!strcmp (name, "manimyellow_e"))
    ut_array_1d_int_set_3 (c, 232, 193, 28);
  else
    res = -1;
  return res;
}
