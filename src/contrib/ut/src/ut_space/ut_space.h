...
/// \param pt3: point 3
/// \return surface area
extern double ut_space_triangle_area (double *pt1, double *pt2, double *pt3);
...
/// \param pt3: point 3
/// \return perimeter
extern double ut_space_triangle_perimeter (double *pt1, double *pt2, double *pt3);
...
extern void ut_space_triangle_normal (double *pt1, double *pt2, double *pt3, double *normal);
...
extern void ut_space_triangle_centre (double *pt1, double *pt2, double *pt3, double *centre);
...
/// \param centre: centre
/// \note The centre is computed as the average of the 3 vertices, which is also the barycentre
extern void ut_space_tet_centre (double *pt1, double *pt2, double *pt3, double *pt4, double *centre);
...
extern double ut_space_tet_volume (double *pt1, double *pt2, double *pt3, double *pt4);
...
/// \param pt8: point 8
/// \param centre: centre
extern void ut_space_hexa_centre (double *pt1, double *pt2, double *pt3, double *pt4,
				  double *pt5, double *pt6, double *pt7, double *pt8,
				  double *centre);
...
extern double ut_space_hexa_volume (double *pt1, double *pt2, double *pt3, double *pt4,
				    double *pt5, double *pt6, double *pt7, double *pt8);
...
extern void ut_space_points_bisplane (double *pt1, double *pt2, double *plane);
...
/// \param plane: bisector plane
extern void ut_space_points_bisplane_power (double* pt1, double* pt2, double wA,
...
extern void ut_space_point_normal_plane (double *pt, double *normal, double *plane);
...
extern void ut_space_point_line_dist (double *pt, double *basept, double *vect, double *pdist);

/// \brief Get the distance between a point and a line in 2D
/// \param pt: point
/// \param line: line parameters: line[0] = line[1] x + line[2] y
/// \param *pdist: distance
extern void ut_space_point_line_dist_2d (double *pt, double *line, double *pdist);
...
extern void ut_space_point_circle_dist (double *pt, double *centre, double *normal, double rad, double *pdist, double *ptproj);
...
extern void ut_space_point_ellipse_dist (double *pt, double *centre, double *normal, double *dir1, double *dir2, double rad1, double rad2, double *pdist, double *ptproj);
...
extern int ut_space_point_plane_side_tol (double *pt, double *plane, double tol);
...
extern int ut_space_point_sphere_side (double *pt, double *centre, double rad);
...
/// \return -1 if on negative side (inside), 1 if on positive side (outside)
extern int ut_space_point_cyl_side (double *pt, double *basept, double *normal, double rad);
...
extern int ut_space_point_ecyl_side (double *pt, double *basept,
                                     ...
                                     double *dir2, double rad1, double rad2);
...
extern void ut_space_point_sphere_tangentplane (double *pt, double *centre, double rad, double *plane);
...
extern void ut_space_point_cyl_tangentplane (double *pt, double *basept, double *axis, double rad, double *plane);
...
extern void ut_space_point_ecyl_tangentplane (double *pt, double *basept, double *axis, double *dir1, double *dir2, double rad1, double rad2, double *plane);
...
extern void ut_space_point_torus_tangentplane (double *pt, double *basept, double *axis, double rad, double rad2, double *plane);
...
extern void ut_space_point_dir_plane_proj (double *pt, double *dir, double *plane, double *projpt);

/// \brief Get the projection of a point onto a plane along its normal
/// \param pt: point
/// \param plane: plane
/// \param projpt: projected point
extern void ut_space_point_plane_proj (double *pt, double *plane, double *projpt);
...
/// \note the cylinder is considered infinite
extern void ut_space_point_cyl_proj (double *pt, double *basept, double *axis, double rad, double *projpt);
...
/// \param rad: sphere radius
/// \param projpt: projection
extern void ut_space_point_sphere_proj (double *point, double *centre, double rad, double *projpt);
...
/// \param rad2: small radius
/// \param projpt: projected point
extern void ut_space_point_torus_proj (double *pt, double *centre, double *axis, double rad, double rad2, double *projpt);
...
/// \param projpt: projected point
/// \note the elliptic cylinder is considered infinite
extern void ut_space_point_ecyl_proj (double *pt, double *basept, double *axis,
                                      double *dir1, double *dir2, double rad1, double rad2,
                                      double *projpt);
...
extern void ut_space_point_plane_mirror (double *pt, double *plane, double *mirpt);
...
/// \param rad: sphere radius
/// \param mirpt: mirror point
extern void ut_space_point_sphere_mirror (double *pt, double *centre, double rad, double *mirpt);
...
/// \param mirpt: mirror point
/// \note the cylinder is considered infinite
extern void ut_space_point_cyl_mirror (double *pt, double *basept, double *axis, double rad, double *mirpt);
...
/// \note the elliptic cylinder is considered infinite
/// \note if the point does not belong to the elliptic cylinder, the nearest point is considered
extern void ut_space_point_ecyl_mirror (double *pt, double *basept, double *axis, double *dir1, double *dir2, double rad1, double rad2, double *mirpt);
...
/// \param rad2: small radius
/// \param mirpt: mirror point
extern void ut_space_point_torus_mirror (double *pt, double *centre, double *axis, double rad, double rad2, double *mirpt);
...
extern int ut_space_quad_convex (double *pt1, double *pt2, double *pt3, double *pt4);
...
/// \param pt4: 4th point
/// \return 1 if convex and 0 otherwise
extern int ut_space_quad_convex_int (int *pt1, int *pt2, int *pt3, int *pt4);
...
extern int ut_space_points_aligned (double *pt1, double *pt2, double *pt3, double eps);
...
/// \param pt3: 3rd point
/// \param plane: plane
extern void ut_space_points_plane (double *pt1, double *pt2, double *pt3, double *plane);

/// \brief Get the best fitting plane from a set of points
/// \param pts: points
/// \param ptqty: number of points
/// \param plane: plane
extern void ut_space_pointset_plane (double **pts, int ptqty, double *plane);
...
/// \param normal: normal vector
/// \param plane: plane
extern void ut_space_points_invect_plane (double *pt1, double *pt2, double *normal,
					  double *plane);
...
extern int ut_space_segment_point_in (double *segpt1, double *segpt2, double *pt);
...
extern int ut_space_triangle_point_in (double *tript1, double *tript2, double *tript3,
				       double *pt, double eps1, double eps2);
...
extern int ut_space_tet_point_in (double *tetpt1, double *tetpt2,
                                  double *tetpt3, double *tetpt4, double *pt);
...
extern void ut_space_segment_point_proj (double* segpt1, double* segpt2, double* pt,
                                         double *projpt, double *ppos,
                                         double *pdist);
...
/// \param planeqty: number of constraining planes
/// \param barypt: barycentre
extern int ut_space_points_bary_constrained_2d (double** pts, double* weights,
                                                int ptqty, double** planes,
                                                int planeqty, double* barypt);
...
extern void ut_space_segment_plane_intersect (double *segpt1, double *segpt2,
                                              double *plane, double *interpt);
...
extern void ut_space_polygon_triangles (double *plane, double **pts, int ptqty,
                                        int ***ptriptids, int *ptriptqty);
...
extern void ut_space_random (gsl_rng *r, int *dims, int dimqty, double radmin,
			     double radmax, double *pt);
...
extern void ut_space_points_dir_furthestpt (double **, int, double*, int*);
