...
void
ol_e_pf_stproj (double *e, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_e_g (e, g);
...
void
ol_e_pf_stprojxy (double *e, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_e_g (e, g);
...
void
ol_e_pf_stproj_rad (double *e, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_e_g (e, g);
...
void
ol_e_pf_eaproj (double *e, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_e_g (e, g);
...
void
ol_e_pf_eaprojxy (double *e, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_e_g (e, g);
...
void
ol_e_pf_eaproj_rad (double *e, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_e_g (e, g);
...
void
ol_e_ipf_stproj (double *e, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_e_g (e, g);
...
void
ol_e_ipf_stprojxy (double *e, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_e_g (e, g);
...
void
ol_e_ipf_stproj_rad (double *e, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_e_g (e, g);
...
void
ol_e_ipf_eaproj (double *e, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_e_g (e, g);
...
void
ol_e_ipf_eaprojxy (double *e, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_e_g (e, g);
...
void
ol_e_ipf_eaproj_rad (double *e, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_e_g (e, g);
...
void
ol_e_ipf_crysym_stproj (double *e, double *vect, char* crysym, double *p)
{
  double **g = ol_g_alloc ();
  ol_e_g (e, g);
...
void
ol_e_ipf_crysym_stprojxy (double *e, double *vect, char* crysym, double *p)
{
  double **g = ol_g_alloc ();
  ol_e_g (e, g);
...
void
ol_e_ipf_crysym_stproj_rad (double *e, double *vect, char* crysym, double *p)
{
  double **g = ol_g_alloc ();
  ol_e_g (e, g);
...
void
ol_e_ipf_crysym_eaproj (double *e, double *vect, char* crysym, double *p)
{
  double **g = ol_g_alloc ();
  ol_e_g (e, g);
...
void
ol_e_ipf_crysym_eaprojxy (double *e, double *vect, char* crysym, double *p)
{
  double **g = ol_g_alloc ();
  ol_e_g (e, g);
...
void
ol_e_ipf_crysym_eaproj_rad (double *e, double *vect, char* crysym, double *p)
{
  double **g = ol_g_alloc ();
  ol_e_g (e, g);
...
void
ol_R_pf_stproj (double *R, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_R_g (R, g);
...
void
ol_R_pf_stprojxy (double *R, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_R_g (R, g);
...
void
ol_R_pf_stproj_rad (double *R, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_R_g (R, g);
...
void
ol_R_pf_eaproj (double *R, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_R_g (R, g);
...
void
ol_R_pf_eaprojxy (double *R, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_R_g (R, g);
...
void
ol_R_pf_eaproj_rad (double *R, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_R_g (R, g);
...
void
ol_R_ipf_stproj (double *R, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_R_g (R, g);
...
void
ol_R_ipf_stprojxy (double *R, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_R_g (R, g);
...
void
ol_R_ipf_stproj_rad (double *R, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_R_g (R, g);
...
void
ol_R_ipf_eaproj (double *R, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_R_g (R, g);
...
void
ol_R_ipf_eaprojxy (double *R, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_R_g (R, g);
...
void
ol_R_ipf_eaproj_rad (double *R, double *vect, double *p)
{
  double **g = ol_g_alloc ();
  ol_R_g (R, g);
...
void
ol_R_ipf_crysym_stproj (double *R, double *vect, char* crysym, double *p)
{
  double **g = ol_g_alloc ();
  ol_R_g (R, g);
...
void
ol_R_ipf_crysym_stprojxy (double *R, double *vect, char* crysym, double *p)
{
  double **g = ol_g_alloc ();
  ol_R_g (R, g);
...
void
ol_R_ipf_crysym_stproj_rad (double *R, double *vect, char* crysym, double *p)
{
  double **g = ol_g_alloc ();
  ol_R_g (R, g);
...
void
ol_R_ipf_crysym_eaproj (double *R, double *vect, char* crysym, double *p)
{
  double **g = ol_g_alloc ();
  ol_R_g (R, g);
...
void
ol_R_ipf_crysym_eaprojxy (double *R, double *vect, char* crysym, double *p)
{
  double **g = ol_g_alloc ();
  ol_R_g (R, g);
...
void
ol_R_ipf_crysym_eaproj_rad (double *R, double *vect, char* crysym, double *p)
{
  double **g = ol_g_alloc ();
  ol_R_g (R, g);
