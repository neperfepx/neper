...
void
ol_crys_set_this (struct OL_CRYS* pCrys, char* structure, double a, double nu, char* rho_min)
{
...
ol_crys_set_mat (struct OL_CRYS* pCrys, char* mat)
{
  ...
  fcc_m[ 0][0] =  1;  fcc_m[ 0][1] =  1;  fcc_m[ 0][2] =  1;
  fcc_m[ 1][0] =  1;  fcc_m[ 1][1] =  1;  fcc_m[ 1][2] =  1;
  fcc_m[ 2][0] =  1;  fcc_m[ 2][1] =  1;  fcc_m[ 2][2] =  1;
  fcc_m[ 3][0] =  1;  fcc_m[ 3][1] =  1;  fcc_m[ 3][2] = -1;
  fcc_m[ 4][0] =  1;  fcc_m[ 4][1] =  1;  fcc_m[ 4][2] = -1;
  fcc_m[ 5][0] =  1;  fcc_m[ 5][1] =  1;  fcc_m[ 5][2] = -1;
  fcc_m[ 6][0] =  1;  fcc_m[ 6][1] = -1;  fcc_m[ 6][2] =  1;
  fcc_m[ 7][0] =  1;  fcc_m[ 7][1] = -1;  fcc_m[ 7][2] =  1;
  fcc_m[ 8][0] =  1;  fcc_m[ 8][1] = -1;  fcc_m[ 8][2] =  1;
  fcc_m[ 9][0] =  1;  fcc_m[ 9][1] = -1;  fcc_m[ 9][2] = -1;
  fcc_m[10][0] =  1;  fcc_m[10][1] = -1;  fcc_m[10][2] = -1;
  fcc_m[11][0] =  1;  fcc_m[11][1] = -1;  fcc_m[11][2] = -1;
  ut_array_2d_scale (fcc_m, 12, 3, OL_IS3);

  fcc_s[ 0][0] =  0;  fcc_s[ 0][1] =  1;  fcc_s[ 0][2] = -1;
  fcc_s[ 1][0] =  1;  fcc_s[ 1][1] =  0;  fcc_s[ 1][2] = -1;
  fcc_s[ 2][0] =  1;  fcc_s[ 2][1] = -1;  fcc_s[ 2][2] =  0;
  fcc_s[ 3][0] =  0;  fcc_s[ 3][1] =  1;  fcc_s[ 3][2] =  1;
  fcc_s[ 4][0] =  1;  fcc_s[ 4][1] =  0;  fcc_s[ 4][2] =  1;
  fcc_s[ 5][0] =  1;  fcc_s[ 5][1] = -1;  fcc_s[ 5][2] =  0;
  fcc_s[ 6][0] =  0;  fcc_s[ 6][1] =  1;  fcc_s[ 6][2] =  1;
  fcc_s[ 7][0] =  1;  fcc_s[ 7][1] =  0;  fcc_s[ 7][2] = -1;
  fcc_s[ 8][0] =  1;  fcc_s[ 8][1] =  1;  fcc_s[ 8][2] =  0;
  fcc_s[ 9][0] =  0;  fcc_s[ 9][1] =  1;  fcc_s[ 9][2] = -1;
  fcc_s[10][0] =  1;  fcc_s[10][1] =  0;  fcc_s[10][2] =  1;
  fcc_s[11][0] =  1;  fcc_s[11][1] =  1;  fcc_s[11][2] =  0;
  ut_array_2d_scale (fcc_s, 12, 3, OL_IS2);

  fcc_t[ 0][0] = -2;  fcc_t[ 0][1] =  1;  fcc_t[ 0][2] =  1;
  fcc_t[ 1][0] = -1;  fcc_t[ 1][1] =  2;  fcc_t[ 1][2] = -1;
  fcc_t[ 2][0] =  1;  fcc_t[ 2][1] =  1;  fcc_t[ 2][2] = -2;
  fcc_t[ 3][0] =  2;  fcc_t[ 3][1] = -1;  fcc_t[ 3][2] =  1;
  fcc_t[ 4][0] =  1;  fcc_t[ 4][1] = -2;  fcc_t[ 4][2] = -1;
  fcc_t[ 5][0] = -1;  fcc_t[ 5][1] = -1;  fcc_t[ 5][2] = -2;
  fcc_t[ 6][0] = -2;  fcc_t[ 6][1] = -1;  fcc_t[ 6][2] =  1;
  fcc_t[ 7][0] =  1;  fcc_t[ 7][1] =  2;  fcc_t[ 7][2] =  1;
  fcc_t[ 8][0] = -1;  fcc_t[ 8][1] =  1;  fcc_t[ 8][2] =  2;
  fcc_t[ 9][0] =  2;  fcc_t[ 9][1] =  1;  fcc_t[ 9][2] =  1;
  fcc_t[10][0] = -1;  fcc_t[10][1] = -2;  fcc_t[10][2] =  1;
  fcc_t[11][0] =  1;  fcc_t[11][1] = -1;  fcc_t[11][2] =  2;
  ut_array_2d_scale (fcc_t, 12, 3, OL_IS6);

  ut_array_2d_memcpy (fcc_s_gnd, 12, 3, fcc_s);
  fcc_s_gnd[12][0] =  1;  fcc_s_gnd[12][1] =  1;  fcc_s_gnd[12][2] =  0;
  fcc_s_gnd[13][0] =  1;  fcc_s_gnd[13][1] =  0;  fcc_s_gnd[13][2] =  1;
  fcc_s_gnd[14][0] =  0;  fcc_s_gnd[14][1] =  1;  fcc_s_gnd[14][2] =  1;
  fcc_s_gnd[15][0] = -1;  fcc_s_gnd[15][1] =  1;  fcc_s_gnd[15][2] =  0;
  fcc_s_gnd[16][0] =  1;  fcc_s_gnd[16][1] =  0;  fcc_s_gnd[16][2] = -1;
  fcc_s_gnd[17][0] =  0;  fcc_s_gnd[17][1] = -1;  fcc_s_gnd[17][2] =  1;
  ut_array_2d_scale (fcc_s_gnd + 12, 6, 3, OL_IS2);

  ut_array_2d_memcpy (fcc_t_gnd, 12, 3, fcc_t);
  ut_array_2d_memcpy (fcc_t_gnd + 12, 6, 3, fcc_s_gnd);
  ...
  if (! strcmp ((*pCrys).structure, "fcc"))
  {
    ...
    ut_array_2d_memcpy ((*pCrys).s, 12, 3, fcc_s);
    ut_array_2d_memcpy ((*pCrys).m, 12, 3, fcc_m);
    ut_array_2d_memcpy ((*pCrys).t, 12, 3, fcc_t);

    (*pCrys).gnd_size = 18;
    (*pCrys).gnd_s = ut_alloc_2d ((*pCrys).gnd_size, 3);
    (*pCrys).gnd_t = ut_alloc_2d ((*pCrys).gnd_size, 3);

    ut_array_2d_memcpy ((*pCrys).gnd_s, 18, 3, fcc_s_gnd);
    ut_array_2d_memcpy ((*pCrys).gnd_t, 18, 3, fcc_t_gnd);
  }
  else
    abort ();
