                        ...
                        struct MESH *Mesh)
{
  ...
  {
    if ((*pTess).VerQty > 0)
      neut_tess_scale (pTess, 1 / MeshPara.clratio[0],
    ...
    if ((*pNodes).NodeQty > 0)
    {
      neut_nodes_scale (pNodes, 1 / MeshPara.clratio[0],
                        1 / MeshPara.clratio[1], 1 / MeshPara.clratio[2]);
...
void
nem_meshing_para_unscale (struct MESHPARA MeshPara, struct TESS *pTess,
