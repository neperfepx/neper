...
#define NEUT_DATA_GEN_H
  ...
  extern void neut_data_ori_color_ipf (double **data, int size, char *crysym, char *scheme, int **Col);

  extern void neut_data_real_real (double **data, int size, double *trs);
