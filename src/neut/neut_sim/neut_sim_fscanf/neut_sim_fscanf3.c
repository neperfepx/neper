...
void
neut_sim_fscanf_domain_vers (struct SIM *pTess, FILE * file)
{
  int i, id, tmp;
...
void
neut_sim_fscanf_domain_edges_v2p0 (struct SIM *pTess, FILE * file)
{
  int i, id;
  ...
  neut_sim_init_domain_domveredge (pTess);

  return;
}

void
neut_sim_fscanf_domain_edges_v3p3 (struct SIM *pTess, FILE * file)
{
  int i, id;
...
void
neut_sim_fscanf_domain_faces_v2p0 (struct SIM *pTess, FILE * file)
{
  int i, id;
  ...
  neut_sim_init_domain_domedgeface (pTess);

  return;
}

void
neut_sim_fscanf_domain_faces_v3p3 (struct SIM *pTess, FILE * file)
{
  int i, id;
...
void
neut_sim_fscanf_per_gen (struct SIM *pTess, FILE * file)
{
...
void
neut_sim_fscanf_per_seed (struct SIM *pTess, FILE * file)
{
  int i, j, id, master;
  ...
  neut_sim_init_seedslave (pTess);

  return;
}

void
neut_sim_fscanf_per_face (struct SIM *pTess, FILE * file)
{
  int i, id;
  ...
  neut_sim_init_faceslave (pTess);
  neut_sim_init_facepoly_per (pTess);

  return;
}

void
neut_sim_fscanf_per_edge (struct SIM *pTess, FILE * file)
{
  int i, id;
  ...
  neut_sim_init_edgeslave (pTess);

  if ((*pTess).Dim == 2)
    neut_sim_init_edgefacenb_per (pTess);

  return;
}

void
neut_sim_fscanf_per_ver (struct SIM *pTess, FILE * file)
{
  int i, id;
  ...
  neut_sim_init_verslave (pTess);

  return;
}

void
neut_sim_fscanf_scale_gen (struct SIM *pTess, FILE * file)
{
...
void
neut_sim_fscanf_scale_cellid (struct SIM *pTess, FILE * file)
{
  int i, id;
