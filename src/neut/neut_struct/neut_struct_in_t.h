...
#define STRUCTIN_T_H
  ...
  struct IN_T
  {
    ...
    // optimization / neighbors
    char **optineighstring;
    char ***optineigh;
    ...
    // optimization / limit distance (-*optideltamax and -*optiboundlower -*optiboundupper)
    char **optideltamaxstring;
    char ***optideltamax;
    char **optiboundlstring;
    char ***optiboundl;
    char **optiboundustring;
    char ***optiboundu;
    ...
    char *morphosamplingstring;            // orientation sampling
    char **morphosampling;                 //
