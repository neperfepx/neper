...
#define NEUT_TESR_GEOM_H
  ...
  ///
  ///
  extern int neut_tesr_coo_pos (struct TESR Tesr, double *coo, int mode,
                                int *voxpos);
  ...
  extern int neut_tesr_perpos_pos (struct TESR Tesr, int *per, int *pos,
                                   int *pos2);
  ...
  extern void neut_tesr_cells_centre (struct TESR Tesr, int *cells,
                                      int cellqty, double *coo);
  ...
  extern void neut_tesr_cell_voxs (struct TESR Tesr, int cell, int ***pvoxs,
                                   int *pvoxqty);
  ...
  extern void neut_tesr_group_volume (struct TESR Tesr, int group,
                                      double *pvol);
  extern void neut_tesr_group_volfrac (struct TESR Tesr, int group,
                                       double *pvolfrac);
  extern void neut_tesr_group_area (struct TESR Tesr, int group,
                                    double *parea);
  extern void neut_tesr_group_areafrac (struct TESR Tesr, int group,
                                        double *pareafrac);
  extern void neut_tesr_group_size (struct TESR Tesr, int group,
                                    double *psize);
  extern void neut_tesr_group_sizefrac (struct TESR Tesr, int group,
                                        double *psizefrac);
  ...
  extern void neut_tesr_cell_convexity (struct TESR Tesr, int cell,
                                        double *pval);
  extern void neut_tesr_cell_anisofact (struct TESR Tesr, int cell,
                                        double *pval);
  ...
  extern int neut_tesr_pos3_vox (struct TESR Tesr, int x, int y, int z,
                                 int *pvox);
  ...
  extern void neut_tesr_cell_bbox_coo (struct TESR Tesr, int cell,
                                       double **coo);
