...
int
neut_tess_exprisvar (struct TESS Tess, char *entity, char *expr)
{
  int i, status;
                           ...
                           double *val, char **ptype)
{
  ...
  else
  {
    ...
    {
      if (neut_tess_exprisvar (Tess, entity, expr))
      {
        neut_tess_var_val_one (Tess, NULL, NULL, NULL, entity, j, expr,
                               val + j, &type);
