...
void
nev_print_data_tesr_gen (struct SIM Sim, struct TESR *pTesr, struct DATA *pData, char *entity,
...
void
nev_print_data_tesr_edge (struct DATA *pData, char *attribute, char *datastring)
{
  if (!strcmp (attribute, "rad"))
  {
    ut_string_string ("scal", &(*pData).RadDataType);
...
void
nev_print_data_tesr_voxedge (struct DATA *pData, char *attribute, char *datastring)
{
...
void
nev_print_data_tesr_voidvox (struct DATA *pData, char *attribute, char *datastring)
{
  if (!strcmp (attribute, "col"))
  {
...
void
nev_print_data_tesr_cell2vox (struct TESR Tesr, char *attribute,
