...
void
nev_print_real_png_mesh_3d (FILE * file, struct PRINT Print, struct NODES Nodes,
                   ...
                   struct DATA **MeshData, int ***pprintelt3dface)
{
  ...
  nev_print_real_png_mesh_3d_compress (Print, Nodes, Mesh[3], &N, &M2D,
                              pprintelt3dface, &elt2delt3d, &nodes_new_old);
  ut_print_message (0, 4, "2D...\n");
  nev_print_real_png_mesh_2d_compress (M2D, NULL, &M1D);
  ...
  nev_print_real_png_mesh_3d_print (file, Print, N, M1D, M2D, elt2delt3d,
