...
void
nev_print_real_png_mesh_3d_compress (struct PRINT Print, struct NODES Nodes,
...
{
  nev_print_real_png_mesh_3d_print_real_faces (file, Print, N, M2D, elt2delt3d,
                                 nodes_new_old, NodeData, MeshData);

  nev_print_real_png_mesh_3d_print_real_edges (file, Print, N, M1D, MeshData);
