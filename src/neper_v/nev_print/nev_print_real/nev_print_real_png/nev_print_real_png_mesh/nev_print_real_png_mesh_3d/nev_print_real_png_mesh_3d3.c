...
#include"nev_print_real_png_mesh_3d_.h"
                               ...
                               struct DATA **MeshData)
{
  ...
  if (!strcmp (coldatatype, "elt3d"))
  {
    ...
    nev_print_real_png_mesh2d (file, N, M2D, NULL, rgb, NULL, "elt", Print);
  ...
  else
  {
    ...
    nev_print_real_png_mesh2d (file, N, M2D, NULL, rgb, NULL, "node", Print);
...
void
nev_print_real_png_mesh_3d_print_real_edges (FILE * file, struct PRINT Print, struct NODES N,
