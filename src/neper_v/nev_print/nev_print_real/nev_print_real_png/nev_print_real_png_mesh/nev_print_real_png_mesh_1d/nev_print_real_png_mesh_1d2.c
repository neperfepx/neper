...
#include"nev_print_real_png_mesh_1d_.h"

void
nev_print_real_png_mesh_1d_compress (struct PRINT Print, struct TESS Tess,
...
void
nev_print_real_png_mesh_1d_print (FILE *file, struct PRINT Print, struct NODES Nodes,
                             ...
                             struct DATA **MeshData, int *hidden)
{
  ...
  ut_array_2d_memcpy (Nodes.NodeCoo + 1, Nodes.NodeQty, 3, Coo + 1);
  ...
  nev_print_real_png_mesh1d (file, Nodes, Mesh[1], showelt, Col, Rad, Print);
