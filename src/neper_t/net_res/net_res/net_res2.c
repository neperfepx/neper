...
void
net_res_tess (FILE * file, char *entity, char *format, struct TESS *pTess)
{
  int i, j, resus, qty, invalqty, valqty;
  double *vals = NULL;
...
void
net_res_point (FILE * file, char *format, struct POINT Point,
                struct TESS Tess)
{
  int i, j, resus, invalqty, valqty;
  double *vals = NULL;
  char **invar = NULL, *type = NULL;
  struct NODES Nodes;
  struct MESH Mesh;
...
void
net_res_tesr (FILE * file, char *entity, char *format, struct TESR *pTesr)
{
  int i, j, qty, resus, invalqty, valqty;
  double *vals = NULL;
  char **invar = NULL, *type = NULL;
  double **data = NULL;
  int *dataqty = NULL;
