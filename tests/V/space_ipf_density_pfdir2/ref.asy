...
draw (contour (scale(2.414214)*points, values, new real[] {1.49167,2.98333,4.475,5.96666,7.45833,8.94999,10.4417,11.9333,13.425,14.9167,}, operator --), new pen[] {black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000)});
