...
bounds range=image(v,scale*1.010000*(-1,-1),scale*1.010000*(1,1),Palette);
picture bar;
...
draw (contour (points, values, new real[] {20.3858,40.7717,61.1575,81.5434,101.929,122.315,142.701,163.087,183.473,203.858,}, operator --), new pen[] {black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000)});
