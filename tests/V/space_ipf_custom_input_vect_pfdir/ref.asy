...
draw (contour (scale(2.414214)*points, values, new real[] {8.37437,16.7487,25.1231,33.4975,41.8718,50.2462,58.6206,66.995,75.3693,83.7437,}, operator --), new pen[] {black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000),black+linewidth(0.500000)});
...
sphere (scale(scale/0.414214)*( 0.000000,  0.000000), 0.600000, 0.000000, rgb(1.000000,0.000000,0.000000), 0.000000, rgb(0.000000,0.000000,0.000000), 0.300000);
sphere (scale(scale/0.414214)*(-0.000000,  0.000000), 0.600000, 0.000000, rgb(0.000000,1.000000,0.000000), 0.000000, rgb(0.000000,0.000000,0.000000), 0.300000);
sphere (scale(scale/0.414214)*( 0.000000,  0.000000), 0.600000, 0.000000, rgb(0.000000,0.000000,1.000000), 0.000000, rgb(0.000000,0.000000,0.000000), 0.300000);
sphere (scale(scale/0.414214)*( 0.366025,  0.366025), 0.600000, 0.000000, rgb(1.000000,1.000000,0.000000), 0.000000, rgb(0.000000,0.000000,0.000000), 0.300000);
label("directions", scale(scale)*(-0.083, 0.900), NE);
