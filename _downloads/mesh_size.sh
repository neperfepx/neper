...
$NEPER -M mesh_size_1.tess $C -rcl 0.5             -print mesh_size_1
$NEPER -M mesh_size_1.tess $C -rcl "1,body>0:0.35" -print mesh_size_2
...
convert +append mesh_size_?.png mesh_size.png
