...
On `the GitHub repository <https://github.com/rquey/neper>`_, Neper's official releases are available under the `release tab <https://github.com/rquey/neper/releases>`_.  The latest version of the code is available from the `main <https://github.com/rquey/neper/tree/main>`_ branch.
...
Neper users should preferably report bugs or request new features using the `GitHub issue tracker <https://github.com/rquey/neper/issues>`_. To ask general questions or share comments, use the `Discussions <https://github.com/rquey/neper/discussions>`_.
